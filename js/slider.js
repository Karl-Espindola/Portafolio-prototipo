...
//agregando paginación, por cada imag se agrega un circulo-----
	...
	$(".pagination ol li:eq(0)").css({"color":"white"});
	...
	function siguiente(){
		...
		$(".pagination ol li").css({"color":"#22245F"});
		$(".pagination ol li:eq("+imgSig+")").css({"color":"white"});
		posicion=imgSig;
	}
	...
	function anterior(){
		...
		$(".pagination ol li").css({"color":"#22245F"});
		$(".pagination ol li:eq("+imgAnt+")").css({"color":"white"});
		posicion=imgAnt;
	}
	...
	function pagination(){
		...
		$('.pagination ol li').css({'color':'#22245F'});
		$(this).css({'color':'white'}); //con $(this) nos referimos al elemento cliqueado
		}
